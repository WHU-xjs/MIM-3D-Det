...
data = dict(
    ...
    val=dict(
        ...
        box_type_3d='LiDAR',
        load_interval=1),
    # the saved config is modified to test split
    test=dict(
        type='NuScenesDatasetMap',
        data_root='data/nuscenes/',
        ann_file='data/nuscenes/nus_img_infos_val.pkl',
...
model = dict(
    ...
    encoders=[
        ...
        dict(
            ...
            conv_group_cfg=dict(
                ...
                input_channels=6,
                out_channels=[32, 80, 80],
                mid_channels=[16, 32, 80],
                strides=[2, 2, 1],
                dilation=3,
                with_se=True,
                norm_cfg=None),
    ...
    fuser=dict(
        ...
        in_channels=160,
        attention_only=True,
        attention_cfg=dict(type='BAM_LN'),
    ...
    decoder=dict(
        ...
        backbone=dict(
            ...
            numC_middle=80,
            norm_cfg=dict(type='LN')),
        neck=dict(type='FPN_LSS_LN', in_channels=800, out_channels=256)),
    head=dict(
        type='CenterHead',
        in_channels=256,
        tasks=[
...
log_level = 'INFO'
work_dir = 'exp/nus/mim/mim-bs1-lr05-aug10-01/'
load_from = None
resume_from = None
workflow = [('train', 1)]
